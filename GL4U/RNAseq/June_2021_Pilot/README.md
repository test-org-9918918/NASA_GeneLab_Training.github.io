...
This directory holds the installation instructions and training materials used for the pilot GL4U: RNA sequencing (RNAseq) bootcamp. The pilot GL4U: RNAseq bootcamp was developed through a collaboration between [NASA GeneLab](https://genelab.nasa.gov/), [](), and [](), and contains command line introductory and space biology-specific lectures and hands-on instruction using Jupyter Notebooks (JNs) for running general Unix and R commands and RNA sequence (RNAseq) data analysis using [GeneLab's RNAseq standard processing pipeline, revision C](https://github.com/nasa/GeneLab_Data_Processing/blob/master/RNAseq/GL-DPPD-7101-C.md). These materials were organized into a week-long training program as detailed in the [schedule](). 
